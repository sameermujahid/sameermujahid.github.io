 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(L,M){var z=L.length;L.push(M);e:for(;0<z;){var K=z-1>>>1,G=L[K];if(0<i(G,M))L[K]=M,L[z]=G,z=K;else break e}}function n(L){return L.length===0?null:L[0]}function r(L){if(L.length===0)return null;var M=L[0],z=L.pop();if(z!==M){L[0]=z;e:for(var K=0,G=L.length,Mn=G>>>1;K<Mn;){var ft=2*(K+1)-1,Jt=L[ft],Ke=ft+1,Dt=L[Ke];if(0>i(Jt,z))Ke<G&&0>i(Dt,Jt)?(L[K]=Dt,L[Ke]=z,K=Ke):(L[K]=Jt,L[ft]=z,K=ft);else if(Ke<G&&0>i(Dt,z))L[K]=Dt,L[Ke]=z,K=Ke;else break e}}return M}function i(L,M){var z=L.sortIndex-M.sortIndex;return z!==0?z:L.id-M.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var s=Date,a=s.now();e.unstable_now=function(){return s.now()-a}}var l=[],u=[],c=1,d=null,f=3,v=!1,y=!1,x=!1,k=typeof setTimeout=="function"?setTimeout:null,h=typeof clearTimeout=="function"?clearTimeout:null,p=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function m(L){for(var M=n(u);M!==null;){if(M.callback===null)r(u);else if(M.startTime<=L)r(u),M.sortIndex=M.expirationTime,t(l,M);else break;M=n(u)}}function w(L){if(x=!1,m(L),!y)if(n(l)!==null)y=!0,qt(P);else{var M=n(u);M!==null&&te(w,M.startTime-L)}}function P(L,M){y=!1,x&&(x=!1,h(b),b=-1),v=!0;var z=f;try{for(m(M),d=n(l);d!==null&&(!(d.expirationTime>M)||L&&!_());){var K=d.callback;if(typeof K=="function"){d.callback=null,f=d.priorityLevel;var G=K(d.expirationTime<=M);M=e.unstable_now(),typeof G=="function"?d.callback=G:d===n(l)&&r(l),m(M)}else r(l);d=n(l)}if(d!==null)var Mn=!0;else{var ft=n(u);ft!==null&&te(w,ft.startTime-M),Mn=!1}return Mn}finally{d=null,f=z,v=!1}}var T=!1,E=null,b=-1,V=5,R=-1;function _(){return!(e.unstable_now()-R<V)}function J(){if(E!==null){var L=e.unstable_now();R=L;var M=!0;try{M=E(!0,L)}finally{M?pe():(T=!1,E=null)}}else T=!1}var pe;if(typeof p=="function")pe=function(){p(J)};else if(typeof MessageChannel<"u"){var ue=new MessageChannel,Mt=ue.port2;ue.port1.onmessage=J,pe=function(){Mt.postMessage(null)}}else pe=function(){k(J,0)};function qt(L){E=L,T||(T=!0,pe())}function te(L,M){b=k(function(){L(e.unstable_now())},M)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(L){L.callback=null},e.unstable_continueExecution=function(){y||v||(y=!0,qt(P))},e.unstable_forceFrameRate=function(L){0>L||125<L?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):V=0<L?Math.floor(1e3/L):5},e.unstable_getCurrentPriorityLevel=function(){return f},e.unstable_getFirstCallbackNode=function(){return n(l)},e.unstable_next=function(L){switch(f){case 1:case 2:case 3:var M=3;break;default:M=f}var z=f;f=M;try{return L()}finally{f=z}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(L,M){switch(L){case 1:case 2:case 3:case 4:case 5:break;default:L=3}var z=f;f=L;try{return M()}finally{f=z}},e.unstable_scheduleCallback=function(L,M,z){var K=e.unstable_now();switch(typeof z=="object"&&z!==null?(z=z.delay,z=typeof z=="number"&&0<z?K+z:K):z=K,L){case 1:var G=-1;break;case 2:G=250;break;case 5:G=1073741823;break;case 4:G=1e4;break;default:G=5e3}return G=z+G,L={id:c++,callback:M,priorityLevel:L,startTime:z,expirationTime:G,sortIndex:-1},z>K?(L.sortIndex=z,t(u,L),n(l)===null&&L===n(u)&&(x?(h(b),b=-1):x=!0,te(w,z-K))):(L.sortIndex=G,t(l,L),y||v||(y=!0,qt(P))),L},e.unstable_shouldYield=_,e.unstable_wrapCallback=function(L){var M=f;return function(){var z=f;f=M;try{return L.apply(this,arguments)}finally{f=z}}}})(jm);Am.exports=jm;var _v=Am.exports;/**
 * @license React
...
`,M3=()=>g.jsx(O3,{children:g.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",width:"24px",height:"24px",fill:"#ffffff",children:g.jsx("path",{d:"M20.285 5.293a1 1 0 00-1.414 0L9 14.586 5.707 11.293a1 1 0 00-1.414 1.414l4.293 4.293a1 1 0 001.414 0l11-11a1 1 0 000-1.414z"})})}),D3=S.div`
...
3. SSC
   - Year: ${J.year}
   - School: ${J.school}
   - GPA: ${J.gpa}`},m=()=>{const{programming_languages:R,platforms:_,database:J,presentation:pe,web_fundamentals:ue,framework:Mt,additional_skills:qt}=Tt.skills;return`Skills:
...
`)}`,T=()=>{const{name:R,education:_,skills:J,projects:pe,contact:ue}=Tt;return`${R} is a student with skills in ${J.programming_languages.join(", ")} and experience in projects like ${pe[0].name}. Contact ${ue.email} for more information.`},E=R=>{x(R)},b=()=>{window.open("D:/portfolio/src/assets/shaik_sameer_muajhid_resume.pdf")};A.useEffect(()=>{f.current&&(f.current.scrollTop=f.current.scrollHeight)},[e]);const V=["name","education","skills","projects","contact","resume","experience","internship","summary"];return g.jsxs(X4,{children:[g.jsx(Q4,{onClick:()=>u(!l),children:g.jsx(Y4,{size:28})}),g.jsxs(J4,{isVisible:l,children:[g.jsx(Z4,{children:"Know about me"}),g.jsxs(eb,{ref:f,children:[e.map((R,_)=>g.jsx("div",{style:{textAlign:R.sender==="user"?"right":"left"},children:g.jsx(ab,{sender:R.sender,children:R.text})},_)),c&&g.jsx(sb,{children:"Typing"})]}),g.jsxs(tb,{children:[g.jsx(nb,{type:"text",placeholder:"Type your message...",value:n,onChange:y,onKeyPress:R=>{R.key==="Enter"&&x(n)}}),g.jsx(rb,{onClick:()=>x(n),children:"Send"})]}),g.jsx(ib,{children:V.map((R,_)=>g.jsx(ob,{onClick:()=>E(R),children:R},_))})]})]})},ub=S.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
`,wb=()=>g.jsxs(gb,{id:"about",children:[g.jsx(mb,{children:"About Me"}),g.jsxs(yb,{children:[g.jsx(vb,{children:g.jsx("img",{src:hb,alt:"About Me"})}),g.jsxs(xb,{children:[g.jsx("p",{children:"Hello! I’m a passionate and dedicated individual with a keen interest in technology and innovation. My journey in the world of data science and software development has equipped me with a strong skill set in various programming languages and frameworks. I thrive in collaborative environments and enjoy solving complex problems through creative solutions."}),g.jsx("p",{children:"In my free time, I love exploring new technologies, working on personal projects, I am always eager to learn and grow, both personally and professionally."}),g.jsxs("div",{style:{display:"flex",gap:"20px",justifyContent:"center"},children:[g.jsx(pn,{href:"https://www.linkedin.com/in/shaik-sameer-mujahid/",target:"_blank","aria-label":"LinkedIn Profile",children:g.jsx(Yd,{})}),g.jsx(pn,{href:"https://github.com/sameermujahid",target:"_blank","aria-label":"GitHub Profile",children:g.jsx(Gd,{})}),g.jsx(pn,{href:"https://www.instagram.com/sameer.mujahid/",target:"_blank","aria-label":"Instagram Profile",children:g.jsx(Kd,{})}),g.jsx(pn,{href:"https://x.com/sameer__mujahid",target:"_blank","aria-label":"Twitter Profile",children:g.jsx(Wd,{})})]})]})]})]}),Sb=S.div`
    font-family: Arial, sans-serif;
`,kb=()=>g.jsxs(Sb,{children:[g.jsx(GP,{}),g.jsx(eT,{}),g.jsx(wb,{}),g.jsx(lb,{}),g.jsx(wT,{}),g.jsx(db,{}),g.jsx(_3,{}),g.jsx(I3,{})]});Bl.createRoot(document.getElementById("root")).render(g.jsx(Ce.StrictMode,{children:g.jsx(kb,{})}));
