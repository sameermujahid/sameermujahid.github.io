import{r as a,x as L,y as M,L as f,j as t,d as i,m as d,c as $,w as C,z as E,S as G,a as A,A as D,B as P,C as _}from"./index-g-MP4zXN.js";import{u as I,s as F,a as m}from"./useScrollAnimation-DCl4ZY4y.js";import{r as T}from"./resumeData-pHVEvbOx.js";const B=a.createContext(null);function H(){const e=a.useRef(!1);return L(()=>(e.current=!0,()=>{e.current=!1}),[]),e}function O(){const e=H(),[o,n]=a.useState(0),r=a.useCallback(()=>{e.current&&n(o+1)},[o]);return[a.useCallback(()=>M.postRender(r),[r]),o]}const U=e=>!e.isLayoutDirty&&e.willUpdate(!1);function y(){const e=new Set,o=new WeakMap,n=()=>e.forEach(U);return{add:r=>{e.add(r),o.set(r,r.addEventListener("willUpdate",n))},remove:r=>{e.delete(r);const c=o.get(r);c&&(c(),o.delete(r)),n()},dirty:n}}const j=e=>e===!0,K=e=>j(e===!0)||e==="id",V=({children:e,id:o,inherit:n=!0})=>{const r=a.useContext(f),c=a.useContext(B),[u,s]=O(),l=a.useRef(null),p=r.id||c;l.current===null&&(K(n)&&p&&(o=o?p+"-"+o:p),l.current={id:o,group:j(n)&&r.group||y()});const b=a.useMemo(()=>({...l.current,forceRender:u}),[s]);return t.jsx(f.Provider,{value:b,children:e})},h=18,R=26,N=188,W=300,x={type:"spring",stiffness:420,damping:34,mass:.8},g={type:"spring",stiffness:300,damping:30,mass:1},w=(e=0)=>({initial:{opacity:0,y:18,filter:"blur(5px)"},animate:{opacity:1,y:0,filter:"blur(0px)"},exit:{opacity:0,y:10,filter:"blur(3px)"},transition:{delay:e,duration:.35,ease:[.22,1,.36,1]}}),Y=i.div`
  padding: 56px 0 60px;
`,X=i.div`
  margin-bottom: 40px;
`,q=i.div`
